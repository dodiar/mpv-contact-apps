...
export default function UpdateContactForm(props) {
  ...
  return (
    <>
        <button onClick={() => detailContact(props.idContact)} className="btn btn-dark" type="button" data-bs-toggle="modal" 
        data-bs-target="#formUpdateContact">Update</button>
        <div className="modal fade" id="formUpdateContact" tabIndex="-1"
        aria-labelledby="formUpdateContactLabel" aria-hidden="true">
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Form Update Contact</h5>
                  <button onClick={() => resetForm()} type="button" className="btn-close"
